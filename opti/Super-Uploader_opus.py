...
def set_n8n_log_bridge(enabled: bool):
    global _n8n_log_bridge_enabled
    _n8n_log_bridge_enabled = enabled

def set_n8n_webhook_url(url: str):
    try:
        import v2_formatter as vf
        vf.N8N_WEBHOOK_URL = url
    except Exception:
        pass
...
def create_gradio_ui():
    if not _GRADIO_AVAILABLE:
        print("Gradio not available. Install it to use the Gradio GUI.")
        return
